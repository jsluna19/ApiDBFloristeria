...
import com.Api_DB_Floristeria_Amistad.domain.service.ClienteService;
...
public class ClienteController {
    ...
    public Optional<Cliente> update(@PathVariable("clienteId") Integer clienteId, @RequestBody Cliente cliente){
